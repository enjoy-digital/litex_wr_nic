//--------------------------------------------------------------------------------
// Auto-generated by LiteX (9c07b45f) on 2024-06-27 14:56:14
//--------------------------------------------------------------------------------
...
#define CSR_ANALYZER_TRIGGER_MEM_VALUE_ADDR (CSR_BASE + 0x18L)
#define CSR_ANALYZER_TRIGGER_MEM_VALUE_SIZE 2
#define CSR_ANALYZER_TRIGGER_MEM_FULL_ADDR (CSR_BASE + 0x20L)
#define CSR_ANALYZER_TRIGGER_MEM_FULL_SIZE 1
#define CSR_ANALYZER_SUBSAMPLER_VALUE_ADDR (CSR_BASE + 0x24L)
#define CSR_ANALYZER_SUBSAMPLER_VALUE_SIZE 1
#define CSR_ANALYZER_STORAGE_ENABLE_ADDR (CSR_BASE + 0x28L)
#define CSR_ANALYZER_STORAGE_ENABLE_SIZE 1
#define CSR_ANALYZER_STORAGE_DONE_ADDR (CSR_BASE + 0x2cL)
#define CSR_ANALYZER_STORAGE_DONE_SIZE 1
#define CSR_ANALYZER_STORAGE_LENGTH_ADDR (CSR_BASE + 0x30L)
#define CSR_ANALYZER_STORAGE_LENGTH_SIZE 1
#define CSR_ANALYZER_STORAGE_OFFSET_ADDR (CSR_BASE + 0x34L)
#define CSR_ANALYZER_STORAGE_OFFSET_SIZE 1
#define CSR_ANALYZER_STORAGE_MEM_LEVEL_ADDR (CSR_BASE + 0x38L)
#define CSR_ANALYZER_STORAGE_MEM_LEVEL_SIZE 1
#define CSR_ANALYZER_STORAGE_MEM_DATA_ADDR (CSR_BASE + 0x3cL)
...
/* WRS_RX_CONFIG Registers */
#define CSR_WRS_RX_CONFIG_BASE (CSR_BASE + 0x5000L)
#define CSR_WRS_RX_CONFIG_MAC_LOCAL_ADDR (CSR_BASE + 0x5000L)
#define CSR_WRS_RX_CONFIG_MAC_LOCAL_SIZE 2
#define CSR_WRS_RX_CONFIG_MAC_REMOTE_ADDR (CSR_BASE + 0x5008L)
#define CSR_WRS_RX_CONFIG_MAC_REMOTE_SIZE 2
#define CSR_WRS_RX_CONFIG_ETHERTYPE_ADDR (CSR_BASE + 0x5010L)
#define CSR_WRS_RX_CONFIG_ETHERTYPE_SIZE 1
#define CSR_WRS_RX_CONFIG_ACCEPT_BROADCASTS_ADDR (CSR_BASE + 0x5014L)
#define CSR_WRS_RX_CONFIG_ACCEPT_BROADCASTS_SIZE 1
#define CSR_WRS_RX_CONFIG_FILTER_REMOTE_ADDR (CSR_BASE + 0x5018L)
#define CSR_WRS_RX_CONFIG_FILTER_REMOTE_SIZE 1
#define CSR_WRS_RX_CONFIG_FIXED_LATENCY_ADDR (CSR_BASE + 0x501cL)
#define CSR_WRS_RX_CONFIG_FIXED_LATENCY_SIZE 1
#define CSR_WRS_RX_CONFIG_FIXED_LATENCY_TIMEOUT_ADDR (CSR_BASE + 0x5020L)
#define CSR_WRS_RX_CONFIG_FIXED_LATENCY_TIMEOUT_SIZE 1
#define CSR_WRS_RX_CONFIG_SW_RESET_ADDR (CSR_BASE + 0x5024L)
#define CSR_WRS_RX_CONFIG_SW_RESET_SIZE 1

/* WRS_RX_CONFIG Fields */

/* WRS_TX_CONFIG Registers */
#define CSR_WRS_TX_CONFIG_BASE (CSR_BASE + 0x5800L)
#define CSR_WRS_TX_CONFIG_MAC_LOCAL_ADDR (CSR_BASE + 0x5800L)
#define CSR_WRS_TX_CONFIG_MAC_LOCAL_SIZE 2
#define CSR_WRS_TX_CONFIG_MAC_TARGET_ADDR (CSR_BASE + 0x5808L)
#define CSR_WRS_TX_CONFIG_MAC_TARGET_SIZE 2
#define CSR_WRS_TX_CONFIG_ETHERTYPE_ADDR (CSR_BASE + 0x5810L)
#define CSR_WRS_TX_CONFIG_ETHERTYPE_SIZE 1
#define CSR_WRS_TX_CONFIG_QTAG_ENA_ADDR (CSR_BASE + 0x5814L)
#define CSR_WRS_TX_CONFIG_QTAG_ENA_SIZE 1
#define CSR_WRS_TX_CONFIG_QTAG_VID_ADDR (CSR_BASE + 0x5818L)
#define CSR_WRS_TX_CONFIG_QTAG_VID_SIZE 1
#define CSR_WRS_TX_CONFIG_QTAG_PRIO_ADDR (CSR_BASE + 0x581cL)
#define CSR_WRS_TX_CONFIG_QTAG_PRIO_SIZE 1
#define CSR_WRS_TX_CONFIG_SW_RESET_ADDR (CSR_BASE + 0x5820L)
#define CSR_WRS_TX_CONFIG_SW_RESET_SIZE 1

/* WRS_TX_CONFIG Fields */
