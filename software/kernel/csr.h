...
#define CSR_PCIE_DMA0_READER_ENABLE_ADDR (CSR_BASE + 0x3804L)
...
#define CSR_PPS_MACRO_DELAY_BASE (CSR_BASE + 0x5800L)
#define CSR_PPS_MACRO_DELAY_VALUE_ADDR (CSR_BASE + 0x5800L)
#define CSR_PPS_MACRO_DELAY_VALUE_SIZE 1

/* PPS_MACRO_DELAY Fields */

/* PPS_OUT_COARSE_DELAY Registers */
#define CSR_PPS_OUT_COARSE_DELAY_BASE (CSR_BASE + 0x6000L)
#define CSR_PPS_OUT_COARSE_DELAY_VALUE_ADDR (CSR_BASE + 0x6000L)
#define CSR_PPS_OUT_COARSE_DELAY_VALUE_SIZE 1

/* PPS_OUT_COARSE_DELAY Fields */

/* PTM_REQUESTER Registers */
#define CSR_PTM_REQUESTER_BASE (CSR_BASE + 0x6800L)
#define CSR_PTM_REQUESTER_CONTROL_ADDR (CSR_BASE + 0x6800L)
#define CSR_PTM_REQUESTER_CONTROL_SIZE 1
#define CSR_PTM_REQUESTER_STATUS_ADDR (CSR_BASE + 0x6804L)
#define CSR_PTM_REQUESTER_STATUS_SIZE 1
#define CSR_PTM_REQUESTER_PHY_TX_DELAY_ADDR (CSR_BASE + 0x6808L)
#define CSR_PTM_REQUESTER_PHY_TX_DELAY_SIZE 1
#define CSR_PTM_REQUESTER_PHY_RX_DELAY_ADDR (CSR_BASE + 0x680cL)
#define CSR_PTM_REQUESTER_PHY_RX_DELAY_SIZE 1
#define CSR_PTM_REQUESTER_MASTER_TIME_ADDR (CSR_BASE + 0x6810L)
#define CSR_PTM_REQUESTER_MASTER_TIME_SIZE 2
#define CSR_PTM_REQUESTER_LINK_DELAY_ADDR (CSR_BASE + 0x6818L)
#define CSR_PTM_REQUESTER_LINK_DELAY_SIZE 1
#define CSR_PTM_REQUESTER_T1_TIME_ADDR (CSR_BASE + 0x681cL)
#define CSR_PTM_REQUESTER_T1_TIME_SIZE 2
#define CSR_PTM_REQUESTER_T4_TIME_ADDR (CSR_BASE + 0x6824L)
...
#define CSR_TIME_GENERATOR_BASE (CSR_BASE + 0x7000L)
#define CSR_TIME_GENERATOR_CONTROL_ADDR (CSR_BASE + 0x7000L)
#define CSR_TIME_GENERATOR_CONTROL_SIZE 1
#define CSR_TIME_GENERATOR_READ_TIME_ADDR (CSR_BASE + 0x7004L)
#define CSR_TIME_GENERATOR_READ_TIME_SIZE 2
#define CSR_TIME_GENERATOR_WRITE_TIME_ADDR (CSR_BASE + 0x700cL)
...
#define CSR_UART_UART_CONTROL_ADDR (CSR_BASE + 0x7800L)
#define CSR_UART_UART_CONTROL_SIZE 1
#define CSR_UART_UART_XOVER_RXTX_ADDR (CSR_BASE + 0x7804L)
#define CSR_UART_UART_XOVER_RXTX_SIZE 1
#define CSR_UART_UART_XOVER_TXFULL_ADDR (CSR_BASE + 0x7808L)
#define CSR_UART_UART_XOVER_TXFULL_SIZE 1
#define CSR_UART_UART_XOVER_RXEMPTY_ADDR (CSR_BASE + 0x780cL)
#define CSR_UART_UART_XOVER_RXEMPTY_SIZE 1
#define CSR_UART_UART_XOVER_EV_STATUS_ADDR (CSR_BASE + 0x7810L)
#define CSR_UART_UART_XOVER_EV_STATUS_SIZE 1
#define CSR_UART_UART_XOVER_EV_PENDING_ADDR (CSR_BASE + 0x7814L)
#define CSR_UART_UART_XOVER_EV_PENDING_SIZE 1
#define CSR_UART_UART_XOVER_EV_ENABLE_ADDR (CSR_BASE + 0x7818L)
#define CSR_UART_UART_XOVER_EV_ENABLE_SIZE 1
#define CSR_UART_UART_XOVER_TXEMPTY_ADDR (CSR_BASE + 0x781cL)
#define CSR_UART_UART_XOVER_TXEMPTY_SIZE 1
#define CSR_UART_UART_XOVER_RXFULL_ADDR (CSR_BASE + 0x7820L)
#define CSR_UART_UART_XOVER_RXFULL_SIZE 1

/* UART Fields */
#define CSR_UART_UART_CONTROL_SEL_OFFSET 0
#define CSR_UART_UART_CONTROL_SEL_SIZE 1
#define CSR_UART_UART_XOVER_EV_STATUS_TX_OFFSET 0
#define CSR_UART_UART_XOVER_EV_STATUS_TX_SIZE 1
#define CSR_UART_UART_XOVER_EV_STATUS_RX_OFFSET 1
#define CSR_UART_UART_XOVER_EV_STATUS_RX_SIZE 1
#define CSR_UART_UART_XOVER_EV_PENDING_TX_OFFSET 0
#define CSR_UART_UART_XOVER_EV_PENDING_TX_SIZE 1
#define CSR_UART_UART_XOVER_EV_PENDING_RX_OFFSET 1
#define CSR_UART_UART_XOVER_EV_PENDING_RX_SIZE 1
#define CSR_UART_UART_XOVER_EV_ENABLE_TX_OFFSET 0
#define CSR_UART_UART_XOVER_EV_ENABLE_TX_SIZE 1
#define CSR_UART_UART_XOVER_EV_ENABLE_RX_OFFSET 1
#define CSR_UART_UART_XOVER_EV_ENABLE_RX_SIZE 1
...
/* EXTCLK_PLL Registers */
#define CSR_EXTCLK_PLL_BASE (CSR_BASE + 0xb800L)
#define CSR_EXTCLK_PLL_RST_ADDR (CSR_BASE + 0xb800L)
#define CSR_EXTCLK_PLL_RST_SIZE 1
#define CSR_EXTCLK_PLL_DONE_ADDR (CSR_BASE + 0xb804L)
#define CSR_EXTCLK_PLL_DONE_SIZE 1
