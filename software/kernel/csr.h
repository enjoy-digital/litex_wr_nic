//--------------------------------------------------------------------------------
// Auto-generated by LiteX (ec06bf595) on 2024-12-02 18:08:24
//--------------------------------------------------------------------------------
...
#define CSR_UART_UART_CONTROL_ADDR (CSR_BASE + 0xf000L)
#define CSR_UART_UART_CONTROL_SIZE 1
#define CSR_UART_UART_XOVER_RXTX_ADDR (CSR_BASE + 0xf004L)
#define CSR_UART_UART_XOVER_RXTX_SIZE 1
#define CSR_UART_UART_XOVER_TXFULL_ADDR (CSR_BASE + 0xf008L)
#define CSR_UART_UART_XOVER_TXFULL_SIZE 1
#define CSR_UART_UART_XOVER_RXEMPTY_ADDR (CSR_BASE + 0xf00cL)
#define CSR_UART_UART_XOVER_RXEMPTY_SIZE 1
#define CSR_UART_UART_XOVER_EV_STATUS_ADDR (CSR_BASE + 0xf010L)
#define CSR_UART_UART_XOVER_EV_STATUS_SIZE 1
#define CSR_UART_UART_XOVER_EV_PENDING_ADDR (CSR_BASE + 0xf014L)
#define CSR_UART_UART_XOVER_EV_PENDING_SIZE 1
#define CSR_UART_UART_XOVER_EV_ENABLE_ADDR (CSR_BASE + 0xf018L)
#define CSR_UART_UART_XOVER_EV_ENABLE_SIZE 1
#define CSR_UART_UART_XOVER_TXEMPTY_ADDR (CSR_BASE + 0xf01cL)
#define CSR_UART_UART_XOVER_TXEMPTY_SIZE 1
#define CSR_UART_UART_XOVER_RXFULL_ADDR (CSR_BASE + 0xf020L)
