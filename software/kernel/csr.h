...
#define CSR_ETHMAC0_SRAM_WRITER_PCIE_HOST_ADDRS_ADDR (CSR_BASE + 0x8828L)
#define CSR_ETHMAC0_SRAM_WRITER_PCIE_HOST_ADDRS_SIZE 4
#define CSR_ETHMAC0_SRAM_WRITER_EV_STATUS_ADDR (CSR_BASE + 0x8838L)
#define CSR_ETHMAC0_SRAM_WRITER_EV_STATUS_SIZE 1
#define CSR_ETHMAC0_SRAM_WRITER_EV_PENDING_ADDR (CSR_BASE + 0x883cL)
#define CSR_ETHMAC0_SRAM_WRITER_EV_PENDING_SIZE 1
#define CSR_ETHMAC0_SRAM_WRITER_EV_ENABLE_ADDR (CSR_BASE + 0x8840L)
#define CSR_ETHMAC0_SRAM_WRITER_EV_ENABLE_SIZE 1
#define CSR_ETHMAC0_SRAM_READER_START_ADDR (CSR_BASE + 0x8844L)
#define CSR_ETHMAC0_SRAM_READER_START_SIZE 1
#define CSR_ETHMAC0_SRAM_READER_READY_ADDR (CSR_BASE + 0x8848L)
#define CSR_ETHMAC0_SRAM_READER_READY_SIZE 1
#define CSR_ETHMAC0_SRAM_READER_LEVEL_ADDR (CSR_BASE + 0x884cL)
#define CSR_ETHMAC0_SRAM_READER_LEVEL_SIZE 1
#define CSR_ETHMAC0_SRAM_READER_SLOT_ADDR (CSR_BASE + 0x8850L)
#define CSR_ETHMAC0_SRAM_READER_SLOT_SIZE 1
#define CSR_ETHMAC0_SRAM_READER_LENGTH_ADDR (CSR_BASE + 0x8854L)
#define CSR_ETHMAC0_SRAM_READER_LENGTH_SIZE 1
#define CSR_ETHMAC0_SRAM_READER_PCIE_HOST_ADDRS_ADDR (CSR_BASE + 0x8858L)
#define CSR_ETHMAC0_SRAM_READER_PCIE_HOST_ADDRS_SIZE 4
#define CSR_ETHMAC0_SRAM_READER_PENDING_SLOTS_ADDR (CSR_BASE + 0x8868L)
#define CSR_ETHMAC0_SRAM_READER_PENDING_SLOTS_SIZE 1
#define CSR_ETHMAC0_SRAM_READER_PENDING_CLEAR_ADDR (CSR_BASE + 0x886cL)
#define CSR_ETHMAC0_SRAM_READER_PENDING_CLEAR_SIZE 1
#define CSR_ETHMAC0_SRAM_READER_EV_STATUS_ADDR (CSR_BASE + 0x8870L)
#define CSR_ETHMAC0_SRAM_READER_EV_STATUS_SIZE 1
#define CSR_ETHMAC0_SRAM_READER_EV_PENDING_ADDR (CSR_BASE + 0x8874L)
#define CSR_ETHMAC0_SRAM_READER_EV_PENDING_SIZE 1
#define CSR_ETHMAC0_SRAM_READER_EV_ENABLE_ADDR (CSR_BASE + 0x8878L)
