...
#define CSR_ETHMAC_SRAM_WRITER_PCIE_HOST_ADDRS_ADDR (CSR_BASE + 0x824L)
#define CSR_ETHMAC_SRAM_WRITER_PCIE_HOST_ADDRS_SIZE 2
#define CSR_ETHMAC_SRAM_WRITER_EV_STATUS_ADDR (CSR_BASE + 0x82cL)
#define CSR_ETHMAC_SRAM_WRITER_EV_STATUS_SIZE 1
#define CSR_ETHMAC_SRAM_WRITER_EV_PENDING_ADDR (CSR_BASE + 0x830L)
#define CSR_ETHMAC_SRAM_WRITER_EV_PENDING_SIZE 1
#define CSR_ETHMAC_SRAM_WRITER_EV_ENABLE_ADDR (CSR_BASE + 0x834L)
#define CSR_ETHMAC_SRAM_WRITER_EV_ENABLE_SIZE 1
#define CSR_ETHMAC_SRAM_READER_START_ADDR (CSR_BASE + 0x838L)
#define CSR_ETHMAC_SRAM_READER_START_SIZE 1
#define CSR_ETHMAC_SRAM_READER_READY_ADDR (CSR_BASE + 0x83cL)
#define CSR_ETHMAC_SRAM_READER_READY_SIZE 1
#define CSR_ETHMAC_SRAM_READER_LEVEL_ADDR (CSR_BASE + 0x840L)
#define CSR_ETHMAC_SRAM_READER_LEVEL_SIZE 1
#define CSR_ETHMAC_SRAM_READER_SLOT_ADDR (CSR_BASE + 0x844L)
#define CSR_ETHMAC_SRAM_READER_SLOT_SIZE 1
#define CSR_ETHMAC_SRAM_READER_LENGTH_ADDR (CSR_BASE + 0x848L)
#define CSR_ETHMAC_SRAM_READER_LENGTH_SIZE 1
#define CSR_ETHMAC_SRAM_READER_PCIE_HOST_ADDRS_ADDR (CSR_BASE + 0x84cL)
#define CSR_ETHMAC_SRAM_READER_PCIE_HOST_ADDRS_SIZE 2
#define CSR_ETHMAC_SRAM_READER_PENDING_SLOTS_ADDR (CSR_BASE + 0x854L)
#define CSR_ETHMAC_SRAM_READER_PENDING_SLOTS_SIZE 1
#define CSR_ETHMAC_SRAM_READER_CLEAR_PENDING_ADDR (CSR_BASE + 0x858L)
#define CSR_ETHMAC_SRAM_READER_CLEAR_PENDING_SIZE 1
#define CSR_ETHMAC_SRAM_READER_EV_STATUS_ADDR (CSR_BASE + 0x85cL)
#define CSR_ETHMAC_SRAM_READER_EV_STATUS_SIZE 1
#define CSR_ETHMAC_SRAM_READER_EV_PENDING_ADDR (CSR_BASE + 0x860L)
#define CSR_ETHMAC_SRAM_READER_EV_PENDING_SIZE 1
#define CSR_ETHMAC_SRAM_READER_EV_ENABLE_ADDR (CSR_BASE + 0x864L)
