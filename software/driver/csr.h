//--------------------------------------------------------------------------------
// Auto-generated by LiteX (6e9dffdbf) on 2024-09-19 15:47:41
//--------------------------------------------------------------------------------
...
#define CSR_ETHMAC_SRAM_WRITER_PENDING_LENGTH_SIZE 8
#define CSR_ETHMAC_SRAM_WRITER_PCIE_HOST_ADDRS_ADDR (CSR_BASE + 0x83cL)
#define CSR_ETHMAC_SRAM_WRITER_PCIE_HOST_ADDRS_SIZE 8
#define CSR_ETHMAC_SRAM_WRITER_EV_STATUS_ADDR (CSR_BASE + 0x85cL)
#define CSR_ETHMAC_SRAM_WRITER_EV_STATUS_SIZE 1
#define CSR_ETHMAC_SRAM_WRITER_EV_PENDING_ADDR (CSR_BASE + 0x860L)
#define CSR_ETHMAC_SRAM_WRITER_EV_PENDING_SIZE 1
#define CSR_ETHMAC_SRAM_WRITER_EV_ENABLE_ADDR (CSR_BASE + 0x864L)
#define CSR_ETHMAC_SRAM_WRITER_EV_ENABLE_SIZE 1
#define CSR_ETHMAC_SRAM_READER_START_ADDR (CSR_BASE + 0x868L)
#define CSR_ETHMAC_SRAM_READER_START_SIZE 1
#define CSR_ETHMAC_SRAM_READER_READY_ADDR (CSR_BASE + 0x86cL)
#define CSR_ETHMAC_SRAM_READER_READY_SIZE 1
#define CSR_ETHMAC_SRAM_READER_LEVEL_ADDR (CSR_BASE + 0x870L)
#define CSR_ETHMAC_SRAM_READER_LEVEL_SIZE 1
#define CSR_ETHMAC_SRAM_READER_SLOT_ADDR (CSR_BASE + 0x874L)
#define CSR_ETHMAC_SRAM_READER_SLOT_SIZE 1
#define CSR_ETHMAC_SRAM_READER_LENGTH_ADDR (CSR_BASE + 0x878L)
#define CSR_ETHMAC_SRAM_READER_LENGTH_SIZE 1
#define CSR_ETHMAC_SRAM_READER_PCIE_HOST_ADDRS_ADDR (CSR_BASE + 0x87cL)
#define CSR_ETHMAC_SRAM_READER_PCIE_HOST_ADDRS_SIZE 8
#define CSR_ETHMAC_SRAM_READER_PENDING_SLOTS_ADDR (CSR_BASE + 0x89cL)
#define CSR_ETHMAC_SRAM_READER_PENDING_SLOTS_SIZE 1
#define CSR_ETHMAC_SRAM_READER_CLEAR_PENDING_ADDR (CSR_BASE + 0x8a0L)
#define CSR_ETHMAC_SRAM_READER_CLEAR_PENDING_SIZE 1
#define CSR_ETHMAC_SRAM_READER_EV_STATUS_ADDR (CSR_BASE + 0x8a4L)
#define CSR_ETHMAC_SRAM_READER_EV_STATUS_SIZE 1
#define CSR_ETHMAC_SRAM_READER_EV_PENDING_ADDR (CSR_BASE + 0x8a8L)
#define CSR_ETHMAC_SRAM_READER_EV_PENDING_SIZE 1
#define CSR_ETHMAC_SRAM_READER_EV_ENABLE_ADDR (CSR_BASE + 0x8acL)
#define CSR_ETHMAC_SRAM_READER_EV_ENABLE_SIZE 1
#define CSR_ETHMAC_PREAMBLE_CRC_ADDR (CSR_BASE + 0x8b0L)
#define CSR_ETHMAC_PREAMBLE_CRC_SIZE 1
#define CSR_ETHMAC_RX_DATAPATH_PREAMBLE_ERRORS_ADDR (CSR_BASE + 0x8b4L)
#define CSR_ETHMAC_RX_DATAPATH_PREAMBLE_ERRORS_SIZE 1
#define CSR_ETHMAC_RX_DATAPATH_CRC_ERRORS_ADDR (CSR_BASE + 0x8b8L)
