...
#define CSR_ETHMAC_SRAM_WRITER_TEST1_ADDR (CSR_BASE + 0x814L)
#define CSR_ETHMAC_SRAM_WRITER_TEST1_SIZE 1
#define CSR_ETHMAC_SRAM_WRITER_TEST2_ADDR (CSR_BASE + 0x818L)
#define CSR_ETHMAC_SRAM_WRITER_TEST2_SIZE 1
#define CSR_ETHMAC_SRAM_WRITER_TEST3_ADDR (CSR_BASE + 0x81cL)
#define CSR_ETHMAC_SRAM_WRITER_TEST3_SIZE 1
#define CSR_ETHMAC_SRAM_WRITER_PENDING_SLOTS_ADDR (CSR_BASE + 0x820L)
#define CSR_ETHMAC_SRAM_WRITER_PENDING_SLOTS_SIZE 1
#define CSR_ETHMAC_SRAM_WRITER_CLEAR_PENDING_ADDR (CSR_BASE + 0x824L)
#define CSR_ETHMAC_SRAM_WRITER_CLEAR_PENDING_SIZE 1
#define CSR_ETHMAC_SRAM_WRITER_PENDING_LENGTH_ADDR (CSR_BASE + 0x828L)
#define CSR_ETHMAC_SRAM_WRITER_PENDING_LENGTH_SIZE 32
#define CSR_ETHMAC_SRAM_WRITER_PCIE_HOST_ADDRS_ADDR (CSR_BASE + 0x8a8L)
#define CSR_ETHMAC_SRAM_WRITER_PCIE_HOST_ADDRS_SIZE 32
#define CSR_ETHMAC_SRAM_WRITER_EV_STATUS_ADDR (CSR_BASE + 0x928L)
...
#define CSR_ETHMAC_SRAM_WRITER_EV_PENDING_ADDR (CSR_BASE + 0x92cL)
...
#define CSR_ETHMAC_SRAM_WRITER_EV_ENABLE_ADDR (CSR_BASE + 0x930L)
...
#define CSR_ETHMAC_SRAM_READER_START_ADDR (CSR_BASE + 0x934L)
#define CSR_ETHMAC_SRAM_READER_START_SIZE 1
#define CSR_ETHMAC_SRAM_READER_READY_ADDR (CSR_BASE + 0x938L)
#define CSR_ETHMAC_SRAM_READER_READY_SIZE 1
#define CSR_ETHMAC_SRAM_READER_LEVEL_ADDR (CSR_BASE + 0x93cL)
#define CSR_ETHMAC_SRAM_READER_LEVEL_SIZE 1
#define CSR_ETHMAC_SRAM_READER_SLOT_ADDR (CSR_BASE + 0x940L)
#define CSR_ETHMAC_SRAM_READER_SLOT_SIZE 1
#define CSR_ETHMAC_SRAM_READER_LENGTH_ADDR (CSR_BASE + 0x944L)
#define CSR_ETHMAC_SRAM_READER_LENGTH_SIZE 1
#define CSR_ETHMAC_SRAM_READER_PCIE_HOST_ADDRS_ADDR (CSR_BASE + 0x948L)
#define CSR_ETHMAC_SRAM_READER_PCIE_HOST_ADDRS_SIZE 32
#define CSR_ETHMAC_SRAM_READER_PENDING_SLOTS_ADDR (CSR_BASE + 0x9c8L)
#define CSR_ETHMAC_SRAM_READER_PENDING_SLOTS_SIZE 1
#define CSR_ETHMAC_SRAM_READER_CLEAR_PENDING_ADDR (CSR_BASE + 0x9ccL)
#define CSR_ETHMAC_SRAM_READER_CLEAR_PENDING_SIZE 1
#define CSR_ETHMAC_SRAM_READER_EV_STATUS_ADDR (CSR_BASE + 0x9d0L)
...
#define CSR_ETHMAC_SRAM_READER_EV_PENDING_ADDR (CSR_BASE + 0x9d4L)
...
#define CSR_ETHMAC_SRAM_READER_EV_ENABLE_ADDR (CSR_BASE + 0x9d8L)
