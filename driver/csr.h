//--------------------------------------------------------------------------------
// Auto-generated by LiteX (22f46375) on 2024-04-17 12:59:09
//--------------------------------------------------------------------------------
...
#define CSR_ETHMAC_SRAM_WRITER_EV_STATUS_ADDR (CSR_BASE + 0x800L)
...
#define CSR_ETHMAC_SRAM_WRITER_EV_PENDING_ADDR (CSR_BASE + 0x804L)
...
#define CSR_ETHMAC_SRAM_WRITER_EV_ENABLE_ADDR (CSR_BASE + 0x808L)
...
#define CSR_ETHMAC_SRAM_WRITER_SLOT_ADDR (CSR_BASE + 0x80cL)
#define CSR_ETHMAC_SRAM_WRITER_SLOT_SIZE 1
#define CSR_ETHMAC_SRAM_WRITER_LENGTH_ADDR (CSR_BASE + 0x810L)
#define CSR_ETHMAC_SRAM_WRITER_LENGTH_SIZE 1
#define CSR_ETHMAC_SRAM_WRITER_ERRORS_ADDR (CSR_BASE + 0x814L)
#define CSR_ETHMAC_SRAM_WRITER_ERRORS_SIZE 1
#define CSR_ETHMAC_SRAM_WRITER_ENABLE_ADDR (CSR_BASE + 0x818L)
#define CSR_ETHMAC_SRAM_WRITER_ENABLE_SIZE 1
#define CSR_ETHMAC_SRAM_WRITER_DISCARD_ADDR (CSR_BASE + 0x81cL)
#define CSR_ETHMAC_SRAM_WRITER_DISCARD_SIZE 1
#define CSR_ETHMAC_SRAM_WRITER_TEST1_ADDR (CSR_BASE + 0x820L)
#define CSR_ETHMAC_SRAM_WRITER_TEST1_SIZE 1
#define CSR_ETHMAC_SRAM_WRITER_TEST2_ADDR (CSR_BASE + 0x824L)
#define CSR_ETHMAC_SRAM_WRITER_TEST2_SIZE 1
#define CSR_ETHMAC_SRAM_WRITER_TEST3_ADDR (CSR_BASE + 0x828L)
#define CSR_ETHMAC_SRAM_WRITER_TEST3_SIZE 1
#define CSR_ETHMAC_SRAM_WRITER_PENDING_SLOTS_ADDR (CSR_BASE + 0x82cL)
#define CSR_ETHMAC_SRAM_WRITER_PENDING_SLOTS_SIZE 1
#define CSR_ETHMAC_SRAM_WRITER_CLEAR_PENDING_ADDR (CSR_BASE + 0x830L)
#define CSR_ETHMAC_SRAM_WRITER_CLEAR_PENDING_SIZE 1
#define CSR_ETHMAC_SRAM_WRITER_PENDING_LENGTH_ADDR (CSR_BASE + 0x834L)
#define CSR_ETHMAC_SRAM_WRITER_PENDING_LENGTH_SIZE 32
#define CSR_ETHMAC_SRAM_WRITER_PCIE_HOST_ADDRS_ADDR (CSR_BASE + 0x8b4L)
#define CSR_ETHMAC_SRAM_WRITER_PCIE_HOST_ADDRS_SIZE 32
#define CSR_ETHMAC_SRAM_READER_EV_STATUS_ADDR (CSR_BASE + 0x934L)
...
#define CSR_ETHMAC_SRAM_READER_EV_PENDING_ADDR (CSR_BASE + 0x938L)
...
#define CSR_ETHMAC_SRAM_READER_EV_ENABLE_ADDR (CSR_BASE + 0x93cL)
...
#define CSR_ETHMAC_SRAM_READER_START_ADDR (CSR_BASE + 0x940L)
#define CSR_ETHMAC_SRAM_READER_START_SIZE 1
#define CSR_ETHMAC_SRAM_READER_READY_ADDR (CSR_BASE + 0x944L)
#define CSR_ETHMAC_SRAM_READER_READY_SIZE 1
#define CSR_ETHMAC_SRAM_READER_LEVEL_ADDR (CSR_BASE + 0x948L)
#define CSR_ETHMAC_SRAM_READER_LEVEL_SIZE 1
#define CSR_ETHMAC_SRAM_READER_SLOT_ADDR (CSR_BASE + 0x94cL)
#define CSR_ETHMAC_SRAM_READER_SLOT_SIZE 1
#define CSR_ETHMAC_SRAM_READER_LENGTH_ADDR (CSR_BASE + 0x950L)
#define CSR_ETHMAC_SRAM_READER_LENGTH_SIZE 1
#define CSR_ETHMAC_SRAM_READER_PCIE_HOST_ADDRS_ADDR (CSR_BASE + 0x954L)
#define CSR_ETHMAC_SRAM_READER_PCIE_HOST_ADDRS_SIZE 32
#define CSR_ETHMAC_SRAM_READER_PENDING_SLOTS_ADDR (CSR_BASE + 0x9d4L)
#define CSR_ETHMAC_SRAM_READER_PENDING_SLOTS_SIZE 1
#define CSR_ETHMAC_SRAM_READER_CLEAR_PENDING_ADDR (CSR_BASE + 0x9d8L)
#define CSR_ETHMAC_SRAM_READER_CLEAR_PENDING_SIZE 1
#define CSR_ETHMAC_PREAMBLE_CRC_ADDR (CSR_BASE + 0x9dcL)
#define CSR_ETHMAC_PREAMBLE_CRC_SIZE 1
#define CSR_ETHMAC_RX_DATAPATH_PREAMBLE_ERRORS_ADDR (CSR_BASE + 0x9e0L)
#define CSR_ETHMAC_RX_DATAPATH_PREAMBLE_ERRORS_SIZE 1
#define CSR_ETHMAC_RX_DATAPATH_CRC_ERRORS_ADDR (CSR_BASE + 0x9e4L)
#define CSR_ETHMAC_RX_DATAPATH_CRC_ERRORS_SIZE 1

/* ethphy */
#define CSR_ETHPHY_BASE (CSR_BASE + 0x1000L)
#define CSR_ETHPHY_MODE_DETECTION_MODE_ADDR (CSR_BASE + 0x1000L)
#define CSR_ETHPHY_MODE_DETECTION_MODE_SIZE 1
#define CSR_ETHPHY_CRG_RESET_ADDR (CSR_BASE + 0x1004L)
...
#define CSR_PCIE_HOST_PCIE2WB_DMA_BASE (CSR_BASE + 0x3000L)
#define CSR_PCIE_HOST_PCIE2WB_DMA_DMA_RD_ENABLE_ADDR (CSR_BASE + 0x3000L)
#define CSR_PCIE_HOST_PCIE2WB_DMA_DMA_RD_ENABLE_SIZE 1
#define CSR_PCIE_HOST_PCIE2WB_DMA_IRQ_DISABLE_ADDR (CSR_BASE + 0x3004L)
#define CSR_PCIE_HOST_PCIE2WB_DMA_IRQ_DISABLE_SIZE 1
#define CSR_PCIE_HOST_PCIE2WB_DMA_TEST1_ADDR (CSR_BASE + 0x3008L)
#define CSR_PCIE_HOST_PCIE2WB_DMA_TEST1_SIZE 1
#define CSR_PCIE_HOST_PCIE2WB_DMA_TEST2_ADDR (CSR_BASE + 0x300cL)
#define CSR_PCIE_HOST_PCIE2WB_DMA_TEST2_SIZE 1
#define CSR_PCIE_HOST_PCIE2WB_DMA_TEST3_ADDR (CSR_BASE + 0x3010L)
#define CSR_PCIE_HOST_PCIE2WB_DMA_TEST3_SIZE 1

/* pcie_host_wb2pcie_dma */
#define CSR_PCIE_HOST_WB2PCIE_DMA_BASE (CSR_BASE + 0x3800L)
#define CSR_PCIE_HOST_WB2PCIE_DMA_DMA_WR_ENABLE_ADDR (CSR_BASE + 0x3800L)
#define CSR_PCIE_HOST_WB2PCIE_DMA_DMA_WR_ENABLE_SIZE 1
#define CSR_PCIE_HOST_WB2PCIE_DMA_IRQ_DISABLE_ADDR (CSR_BASE + 0x3804L)
#define CSR_PCIE_HOST_WB2PCIE_DMA_IRQ_DISABLE_SIZE 1
#define CSR_PCIE_HOST_WB2PCIE_DMA_TEST1_ADDR (CSR_BASE + 0x3808L)
#define CSR_PCIE_HOST_WB2PCIE_DMA_TEST1_SIZE 1
#define CSR_PCIE_HOST_WB2PCIE_DMA_TEST2_ADDR (CSR_BASE + 0x380cL)
#define CSR_PCIE_HOST_WB2PCIE_DMA_TEST2_SIZE 1
#define CSR_PCIE_HOST_WB2PCIE_DMA_TEST3_ADDR (CSR_BASE + 0x3810L)
#define CSR_PCIE_HOST_WB2PCIE_DMA_TEST3_SIZE 1
