//--------------------------------------------------------------------------------
// Auto-generated by LiteX (1ad0f828) on 2024-06-25 15:13:50
//--------------------------------------------------------------------------------
...
/* PCIE_HOST_PCIE2WB_DMA Registers */
#define CSR_PCIE_HOST_PCIE2WB_DMA_BASE (CSR_BASE + 0x3000L)
#define CSR_PCIE_HOST_PCIE2WB_DMA_IRQ_DISABLE_ADDR (CSR_BASE + 0x3000L)
#define CSR_PCIE_HOST_PCIE2WB_DMA_IRQ_DISABLE_SIZE 1
#define CSR_PCIE_HOST_PCIE2WB_DMA_TEST1_ADDR (CSR_BASE + 0x3004L)
#define CSR_PCIE_HOST_PCIE2WB_DMA_TEST1_SIZE 1
#define CSR_PCIE_HOST_PCIE2WB_DMA_TEST2_ADDR (CSR_BASE + 0x3008L)
#define CSR_PCIE_HOST_PCIE2WB_DMA_TEST2_SIZE 1
#define CSR_PCIE_HOST_PCIE2WB_DMA_TEST3_ADDR (CSR_BASE + 0x300cL)
#define CSR_PCIE_HOST_PCIE2WB_DMA_TEST3_SIZE 1

/* PCIE_HOST_PCIE2WB_DMA Fields */

/* PCIE_HOST_WB2PCIE_DMA Registers */
#define CSR_PCIE_HOST_WB2PCIE_DMA_BASE (CSR_BASE + 0x3800L)
#define CSR_PCIE_HOST_WB2PCIE_DMA_IRQ_DISABLE_ADDR (CSR_BASE + 0x3800L)
#define CSR_PCIE_HOST_WB2PCIE_DMA_IRQ_DISABLE_SIZE 1
#define CSR_PCIE_HOST_WB2PCIE_DMA_TEST1_ADDR (CSR_BASE + 0x3804L)
#define CSR_PCIE_HOST_WB2PCIE_DMA_TEST1_SIZE 1
#define CSR_PCIE_HOST_WB2PCIE_DMA_TEST2_ADDR (CSR_BASE + 0x3808L)
#define CSR_PCIE_HOST_WB2PCIE_DMA_TEST2_SIZE 1
#define CSR_PCIE_HOST_WB2PCIE_DMA_TEST3_ADDR (CSR_BASE + 0x380cL)
#define CSR_PCIE_HOST_WB2PCIE_DMA_TEST3_SIZE 1

/* PCIE_HOST_WB2PCIE_DMA Fields */
