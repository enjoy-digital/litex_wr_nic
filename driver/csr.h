//--------------------------------------------------------------------------------
// Auto-generated by LiteX (22f46375) on 2024-04-17 11:21:37
//--------------------------------------------------------------------------------
...
#define CSR_PCIE_HOST_PCIE2WB_DMA_BASE (CSR_BASE + 0x2800L)
#define CSR_PCIE_HOST_PCIE2WB_DMA_DMA_RD_ENABLE_ADDR (CSR_BASE + 0x2800L)
#define CSR_PCIE_HOST_PCIE2WB_DMA_DMA_RD_ENABLE_SIZE 1
#define CSR_PCIE_HOST_PCIE2WB_DMA_IRQ_DISABLE_ADDR (CSR_BASE + 0x2804L)
#define CSR_PCIE_HOST_PCIE2WB_DMA_IRQ_DISABLE_SIZE 1
#define CSR_PCIE_HOST_PCIE2WB_DMA_TEST1_ADDR (CSR_BASE + 0x2808L)
#define CSR_PCIE_HOST_PCIE2WB_DMA_TEST1_SIZE 1
#define CSR_PCIE_HOST_PCIE2WB_DMA_TEST2_ADDR (CSR_BASE + 0x280cL)
#define CSR_PCIE_HOST_PCIE2WB_DMA_TEST2_SIZE 1
#define CSR_PCIE_HOST_PCIE2WB_DMA_TEST3_ADDR (CSR_BASE + 0x2810L)
#define CSR_PCIE_HOST_PCIE2WB_DMA_TEST3_SIZE 1

/* pcie_host_wb2pcie_dma */
#define CSR_PCIE_HOST_WB2PCIE_DMA_BASE (CSR_BASE + 0x3000L)
#define CSR_PCIE_HOST_WB2PCIE_DMA_DMA_WR_ENABLE_ADDR (CSR_BASE + 0x3000L)
#define CSR_PCIE_HOST_WB2PCIE_DMA_DMA_WR_ENABLE_SIZE 1
#define CSR_PCIE_HOST_WB2PCIE_DMA_IRQ_DISABLE_ADDR (CSR_BASE + 0x3004L)
#define CSR_PCIE_HOST_WB2PCIE_DMA_IRQ_DISABLE_SIZE 1
#define CSR_PCIE_HOST_WB2PCIE_DMA_TEST1_ADDR (CSR_BASE + 0x3008L)
#define CSR_PCIE_HOST_WB2PCIE_DMA_TEST1_SIZE 1
#define CSR_PCIE_HOST_WB2PCIE_DMA_TEST2_ADDR (CSR_BASE + 0x300cL)
#define CSR_PCIE_HOST_WB2PCIE_DMA_TEST2_SIZE 1
#define CSR_PCIE_HOST_WB2PCIE_DMA_TEST3_ADDR (CSR_BASE + 0x3010L)
