...
def patch_wr_syscon_spi_mosi():
    # Verify upstream ff0d6950 (2026-07-01), already included in this revision.
    # GPCR writes must clear MOSI. Testing GPSR here leaves MOSI stuck high.
    _replace_once(WR_SYSCON_VHD,
